...
Point3f {\bfseries get3\+DPoint\+Match} (double u1, double v1, double u2, double v2, string drive)
\item 
...
void {\bfseries get\+Root\+Transformation} (Mat \&Trans, int eye=LEFT)
\item 
...
void {\bfseries set\+Disp\+Parameters} (bool \+\_\+use\+Best\+Disp, int \+\_\+uniqueness\+Ratio, int \+\_\+speckle\+Window\+Size, int \+\_\+speckle\+Range, int \+\_\+number\+Of\+Disparities, int \+\_\+\+SADWindow\+Size, int \+\_\+min\+Disparity, int \+\_\+pre\+Filter\+Cap, int \+\_\+disp12\+Max\+Diff)
\item 
