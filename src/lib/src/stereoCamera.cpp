...
// epipolar geometry constraint: m2^t*F*m1=0
    ...
    Mat R1,R2,P1,P2;
    Rect roi1, roi2;
    stereoRectify( this->Kleft, this->DistL, this->Kright, this->DistR, imageSize, this->R, this->T, R1, R2, P1, P2, this->Q, 0, -1, imageSize, &roi1, &roi2 );
...
void StereoCamera::rectifyImages()
{
    ...
    {
        mutex->wait();
        stereoRectify(this->Kleft, this->DistL, this->Kright, this->DistR, img_size, this->R, this->T, this->RLrect, this->RRrect, this->PLrect, this->PRrect, this->Q, 0, -1, img_size, &roi1, &roi2 );
        mutex->post();
    }
